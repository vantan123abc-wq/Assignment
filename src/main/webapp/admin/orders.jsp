                    ...
                    <c:forEach var="order" items="${orderList}">
                        <tr>
                            ...
                            <td class="action-btns">
                              <a href="order-detail?id=${order.id}" class="text-blue-500 hover:text-blue-700 p-1">
                              <span class="material-symbols-outlined text-xl"><i class="fa-solid fa-eye"></i></span>
</a>
                            </td>
                        </tr>
                    </c:forEach>
    ...
    <script>
       <script>
        function updateStatus(selectElement, orderId) {
            selectElement.classList.remove('status-Pending', 'status-Shipping', 'status-Completed', 'status-Cancelled'); [cite: 199, 200]
            selectElement.classList.add('status-' + selectElement.value);

            // GỬI REQUEST VỚI ĐÚNG ĐƯỜNG DẪN CỦA SERVLET
