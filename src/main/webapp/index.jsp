                    ...
                    <section
                        ...
                        <div class="relative flex flex-col justify-center items-start px-12 lg:px-20 max-w-2xl">
                            ...
                            <p class="text-lg text-slate-200 mb-10 leading-relaxed">
                                Chúng tôi kết nối trực tiếp với những người nông dân tâm huyết nhất để mang đến những
                                sản
                                phẩm
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <c:forEach items="${bestSellers}" var="p">
                                ...
                                <div
                                    ...
                                    <a href="${pageContext.request.contextPath}/product?id=${p.id}" class="block">
                                        <div
                                            ...
                                            <c:set var="bgUrl" value="" />
                                            <c:choose>
                                                <c:when test="${not empty p.imageUrl}">
                                                    <c:set var="bgUrl" value="${p.imageUrl}" />
                                                </c:when>
                                                <c:when
