                ...
                <section class="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    <div class="relative h-full flex flex-col justify-center items-start px-12 lg:px-20 max-w-2xl">
                        ...
                        <p class="text-lg text-slate-200 mb-10 leading-relaxed">
                            Chúng tôi kết nối trực tiếp với những người nông dân tâm huyết nhất để mang đến những sản
                            phẩm
                            ...
                            <div
                                ...
                                <div>
                                    <div
                                        ...
                                        <c:if test="${p.description != null && p.description.startsWith('http')}">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                        ...
                        <div class="space-y-6">
                            ...
                            <p class="text-slate-500 text-sm leading-relaxed">
                                Tự hào là đơn vị cung ứng nông sản sạch hàng đầu Việt Nam. Chúng tôi cam kết chất lượng
                                trên
                                từng sản phẩm.
                            </p>
                        ...
                        <div>
                            ...
                            <ul class="space-y-4 text-sm text-slate-500">
                                <li><a class="hover:text-primary transition-colors" href="#">Chính sách giao hàng</a>
                                </li>
                    ...
                    <div
                        ...
                        <p class="text-slate-400 text-xs text-center md:text-left">
                            © 2024 Nông Sản Việt. Tất cả quyền được bảo lưu. MSDN: 0123456789 được cấp bởi Sở KH&ĐT Hà
                            Nội.
                        </p>
