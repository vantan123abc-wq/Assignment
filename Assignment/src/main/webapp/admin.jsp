...
<body class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 flex h-screen overflow-hidden">

    <aside class="w-64 bg-white dark:bg-slate-900 border-r border-slate-100 dark:border-slate-800 flex flex-col h-full shrink-0">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-2">
            <a href="#" class="flex items-center gap-3 px-4 py-3 bg-primary/10 text-primary rounded-xl font-semibold transition-colors">
                <span class="material-symbols-outlined">dashboard</span> Tổng quan (Chart)
            </a>
            <a href="#" class="flex items-center gap-3 px-4 py-3 text-slate-500 hover:bg-slate-50 hover:text-primary rounded-xl font-medium transition-colors">
        ...
        <div class="p-4 border-t border-slate-100">
            <a href="logout" class="flex items-center justify-center gap-2 w-full p-3 rounded-xl bg-red-50 text-red-600 font-semibold hover:bg-red-100 transition-colors">
    ...
    <main class="flex-1 h-full overflow-y-auto bg-background-light p-8">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center gap-3 bg-white px-4 py-2 rounded-full shadow-sm border border-slate-100">
                ...
                <span class="font-bold">Admin ${sessionScope.account.username}</span>
            </div>
        </div>
        ...
        <div class="space-y-8">
            ...
            <section class="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-xl font-bold flex items-center gap-2">
                        <span class="material-symbols-outlined text-primary">bar_chart</span> Thống kê doanh thu
                    </h3>
                    <select class="bg-slate-50 border-none rounded-xl text-sm font-medium focus:ring-2 focus:ring-primary/50 px-4 py-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <table class="w-full text-sm text-left">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="px-4 py-3 font-medium text-slate-900">nguyenvana@gmail.com</td>
                                    <td class="px-4 py-3"><span class="bg-slate-100 text-slate-600 px-2 py-1 rounded-md text-xs font-bold">User</span></td>
                                    <td class="px-4 py-3 text-right">
                                        <span class="inline-flex items-center gap-1 bg-green-50 text-green-600 px-2.5 py-1 rounded-full text-xs font-bold border border-green-200">
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3"><span class="bg-primary/10 text-primary px-2 py-1 rounded-md text-xs font-bold">Admin</span></td>
                                    <td class="px-4 py-3 text-right">
                                        <span class="inline-flex items-center gap-1 bg-slate-100 text-slate-500 px-2.5 py-1 rounded-full text-xs font-bold">
                ...
                <section class="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm overflow-hidden">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="#" class="text-sm font-semibold text-primary hover:underline">Xem tất cả</a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left">
                            <thead class="text-xs text-slate-500 uppercase bg-slate-50 border-b border-slate-100">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3">
                                        <select class="text-xs font-bold rounded-lg border-slate-200 bg-orange-50 text-orange-600 focus:ring-0 py-1 pl-2 pr-6">
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3">
                                        <select class="text-xs font-bold rounded-lg border-slate-200 bg-green-50 text-green-600 focus:ring-0 py-1 pl-2 pr-6">
            ...
            <section class="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm overflow-hidden">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button class="bg-primary hover:bg-primary/90 text-white font-bold py-2 px-4 rounded-xl text-sm transition-transform active:scale-95 flex items-center gap-2">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-4 py-3 flex items-center gap-3">
                                    <div class="size-10 rounded-lg bg-slate-200 flex items-center justify-center overflow-hidden">
                                        <img src="https://via.placeholder.com/40" alt="img" class="object-cover w-full h-full">
                                    </div>
                                    <div>
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span class="font-bold text-slate-700">120</span> <span class="text-xs text-slate-400">kg</span>
                                </td>
                                <td class="px-4 py-3 text-right font-medium text-primary">45.000₫</td>
                                <td class="px-4 py-3 text-center">
                                    <button class="text-blue-500 hover:text-blue-700 p-1"><span class="material-symbols-outlined text-xl">edit_square</span></button>
                                    <button class="text-red-500 hover:text-red-700 p-1"><span class="material-symbols-outlined text-xl">delete</span></button>
                                </td>
                            </tr>
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-4 py-3 flex items-center gap-3">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span class="font-black text-red-500 bg-red-50 px-2 py-1 rounded-md">4</span> <span class="text-xs text-slate-400">kg</span>
                                </td>
